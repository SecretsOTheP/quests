...
function CallerTimer(e)
	...
	count = count + 1;
	if(count == 1) then
		eq.spawn2(176001,0,1,487,2281,302,135);
		eq.spawn2(176001,0,1,455,2253,305,64);
		eq.spawn2(176001,0,1,475,2229,305,14);
		eq.spawn2(176001,0,1,504,2258,304,184);	
	elseif(count == 2) then
		eq.spawn2(176001,0,1,487,2281,302,135);
		eq.spawn2(176001,0,1,455,2253,305,64);
		eq.spawn2(176001,0,1,475,2229,305,14);
		eq.spawn2(176001,0,1,504,2258,304,184);	
	elseif(count == 3) then
		eq.spawn2(eq.ChooseRandom(176001,176008,176004),0,1,487,2281,302,135);
		eq.spawn2(176001,0,1,455,2253,305,64);
		eq.spawn2(eq.ChooseRandom(176001,176008,176004),0,1,475,2229,305,14);
		eq.spawn2(176001,0,1,504,2258,304,184);	
	elseif(count == 4) then
		eq.spawn2(eq.ChooseRandom(176001,176008,176004),0,1,487,2281,302,135);
		eq.spawn2(176001,0,1,455,2253,305,64);
	...
	elseif(count == 5) then
		...
		eq.spawn2(176001,0,1,504,2258,304,184);	
	elseif(count == 6) then
		eq.spawn2(176000,0,1,482,2254,306,128);
		eq.spawn2(176001,0,1,455,2253,305,64);
		eq.spawn2(176001,0,1,475,2229,305,14);
		eq.spawn2(eq.ChooseRandom(176001,176008,176004),0,1,504,2258,304,184);
		count = 0;
